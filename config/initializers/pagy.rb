...
# Customize only what you really need and notice that the core Pagy works also without any of the
# following lines.
...
# You can set any pagy variable as a Pagy::DEFAULT. They can also be overridden per instance by just
# passing them to
#
...
# you must require the JS Tools internal extra (BEFORE the metadata extra) ONLY if you need also the
# :sequels
#
